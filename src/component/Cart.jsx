                ...
                <div className='col-md-6 col-12'>
                    <table className='table'>
                        <tbody>
                            ...
                            <tr>
                                {
                                    cart.length>=1?                                <td colSpan={2}><Link to="/checkout" className='text-decoration-none d-block rounded text-center w-100 formbtn background text-light'>Checkout</Link></td>:""
                                }
                            </tr>
                        </tbody>
                    </table>
